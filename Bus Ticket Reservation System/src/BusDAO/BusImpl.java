...
public class BusImpl implements BusIntr {
        ...
        try (Connection con = DBUtil.provideConnection()) {
            ...
            if (rs.next()) {
                ...
                if (rs2.next()) {
                    ...
                    if (x > 0) message = "Ticket Booked Sucessfully";
                    else throw new TicketException("Ticket Booking Failed");
                }
    ...
    public String cancelTicket(int bus_no) {
        String message = "Ticket Booking Not Canclelled";
        try (Connection con = DBUtil.provideConnection()) {
            ...
            if (x > 0)
                ...
                System.out.println("Ticket Booking Canclelled Sucessfully");
            else {
                System.out.println("Ticket Cancelling Failed");
            }
